...
if ($pict == '') {
	$brg->edit("UPDATE tb_barang SET nama_brg = '$nama_brg', harga_brg = '$harga_brg', stok_brg = '$stok_brg' WHERE id_brg = '$id_brg'");
}else{
	...
	if ($upload) {
		$brg->edit("UPDATE tb_barang SET nama_brg = '$nama_brg', harga_brg = '$harga_brg', stok_brg = '$stok_brg', gbr_brg = '$gbr_brg' WHERE id_brg = '$id_brg'");
	}else{
