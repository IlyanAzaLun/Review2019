                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                $sql_obat = mysqli_query($con, "SELECT * FROM tb_rm_obat 
                                   JOIN tb_obat ON tb_rm_obat.id_obat = tb_obat.id_obat WHERE id_rm = '$data[id_rm]'") or die(mysqli_error($con));
                                    while ($data_obat = mysqli_fetch_array($sql_obat)) {
                                        echo "<li>".$data_obat['nama_obat']."</li>";
                                    }
                                ?>
                            </td>
                            <td><a href="del.php?id=<?=$data['id_rm']?>" class="btn btn-danger btn-xs" onclick="return confirm('Yakin akan menghapus data?')"><i class="glyphicon glyphicon-trash"></i></a></td>
                        </tr>
                    <?php
                    }
                    ?>
